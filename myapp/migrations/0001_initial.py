    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.paymentmethod')),
                ('shipping_method', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.shippingmethod')),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
